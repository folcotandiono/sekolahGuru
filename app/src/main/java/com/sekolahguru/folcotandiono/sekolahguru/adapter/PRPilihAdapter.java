...
public class PRPilihAdapter extends RecyclerView.Adapter<PRPilihAdapter.ViewHolder> {
...
//                    editor.commit();
    ...
    public PRPilihAdapter(List<PR> listPR) {
        this.listPR = listPR;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public PRPilihAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                        int viewType) {
        // create a new view
